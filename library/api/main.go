...
func main() {
	...
	flag.StringVar(&app.DSN, "dsn", "host=localhost port=5432 user=postgres password=postgres dbname=library sslmode=disable timezone=UTC connect_timeout=5", "Postgres connection string")
